...
let me={
	...
	state:"Alaska",
	age:19,
	greeter:()=>{ return `Hello my name is ${this.firstName} and I live in ${this.state}`}
}
...
// Code Here
let total= myNumbers.reduce((acc,x)=>x+acc)
...
let totallyAwesome=people.reduce((acc,x)=> x.awesomeLevel+acc, 0)
// Code Here
